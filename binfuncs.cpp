...
std::string bin_move(const std::string &reg, const std::string &value) {
    ...
    if (reg == "rax") {
        ...
        return "73 188 " + remove_overflow(value + " ") + get_characters('0', 8 - round(static_cast<double>(value.length()) / 2 ));
    }
    else if (reg == "r13") {
        return "73 189 " + remove_overflow(value + " ") + get_characters('0', 8 - round(static_cast<double>(value.length()) / 2 ));
    }
    else if (reg == "r14") {
        return "73 190 " + remove_overflow(value + " ") + get_characters('0', 8 - round(static_cast<double>(value.length()) / 2 ));
    }
    else if (reg == "r15") {
        return "73 191 " + remove_overflow(value + " ") + get_characters('0', 8 - round(static_cast<double>(value.length()) / 2 ));
    }
...
std::string bin_multiply(const std::string &reg, const std::string &value) {
    ...
    if (reg == "rax") {
        return "72 105 192 " + remove_overflow(value + " ") + get_characters('0', 4 - round(static_cast<double>(value.length()) / 2 ));
    }
    else if (reg == "rcx") {
        return "72 105 201 " + remove_overflow(value + " ") + get_characters('0', 4 - round(static_cast<double>(value.length()) / 2 ));
    }
    else if (reg == "rdx") {
        return "72 105 210 " + remove_overflow(value + " ") + get_characters('0', 4 - round(static_cast<double>(value.length()) / 2 ));
    }
    else if (reg == "rsi") {
        return "72 105 246 " + remove_overflow(value + " ") + get_characters('0', 4 - round(static_cast<double>(value.length()) / 2 ));
    }
    else if (reg == "rdi") {
        return "72 105 255 " + remove_overflow(value + " ") + get_characters('0', 4 - round(static_cast<double>(value.length()) / 2 ));
    }
    else if (reg == "r8") {
        return "77 105 192 " + remove_overflow(value + " ") + get_characters('0', 4 - round(static_cast<double>(value.length()) / 2 ));
    }
    else if (reg == "r9") {
        return "77 105 201 " + remove_overflow(value + " ") + get_characters('0', 4 - round(static_cast<double>(value.length()) / 2 ));
    }
    else if (reg == "r10") {
        return "77 105 210 " + remove_overflow(value + " ") + get_characters('0', 4 - round(static_cast<double>(value.length()) / 2 ));
    }
    else if (reg == "r11") {
        return "77 105 219 " + remove_overflow(value + " ") + get_characters('0', 4 - round(static_cast<double>(value.length()) / 2 ));
    }
    throw std::runtime_error("Parsing error, register given is not supported");
    return "";
}
